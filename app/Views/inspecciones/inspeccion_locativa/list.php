...
<div class="container-fluid px-3">
    <div class="d-flex justify-content-between align-items-center mt-2 mb-3">
        ...
        <a href="<?= site_url('inspecciones/inspeccion-locativa/create') ?>" class="btn btn-sm btn-pwa-primary" style="width:auto; padding: 8px 16px;">
        ...
        <table id="tablaInspecciones" class="table table-striped table-bordered table-hover" style="width:100%">
            <thead>
                ...
                <tr class="filters-row">
                    ...
                    <th><input type="text" placeholder="Hallazgos"></th>
                    <th>
                        <select>
            ...
            <?php foreach (($inspecciones ?? []) as $insp): ?>
                <tr>
                    ...
                    <td><?= date('d/m/Y', strtotime($insp['fecha_inspeccion'])) ?></td>
                    ...
                    <td class="table-actions">
                        <a href="<?= site_url('inspecciones/inspeccion-locativa/edit/' . $insp['id']) ?>" class="btn btn-outline-dark" title="Editar"><i class="fas fa-edit"></i></a>
                        <?php if ($insp['estado'] === 'completo'): ?>
                            <a href="<?= site_url('inspecciones/inspeccion-locativa/view/' . $insp['id']) ?>" class="btn btn-outline-dark" title="Ver"><i class="fas fa-eye"></i></a>
                            <a href="<?= site_url('inspecciones/inspeccion-locativa/pdf/' . $insp['id']) ?>" class="btn btn-outline-success" target="_blank" title="PDF"><i class="fas fa-file-pdf"></i></a>
                        <?php endif; ?>
                        <a href="<?= site_url('inspecciones/inspeccion-locativa/delete/' . $insp['id']) ?>" class="btn btn-outline-danger btn-delete" title="Eliminar"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
