<div class="container-fluid px-3">
    ...
    <?php if (empty($inspecciones)): ?>
        <div class="text-center text-muted py-5">
            ...
            <a href="<?= site_url('inspecciones/inspeccion-locativa/create') ?>" class="btn btn-pwa-primary" style="width:auto; padding: 8px 24px;">
            ...
            <div class="card card-inspeccion <?= esc($insp['estado']) ?> insp-item" data-cliente="<?= strtolower(esc($insp['nombre_cliente'] ?? '')) ?>">
                <div class="card-body py-3 px-3">
                    ...
                    <div class="mt-2 d-flex gap-2 flex-wrap">
                        <a href="<?= site_url('inspecciones/inspeccion-locativa/edit/' . $insp['id']) ?>" class="btn btn-sm btn-outline-dark">
                            <i class="fas fa-edit"></i> Editar
                        </a>
                        <a href="<?= site_url('inspecciones/inspeccion-locativa/delete/' . $insp['id']) ?>" class="btn btn-sm btn-outline-danger btn-delete" data-id="<?= $insp['id'] ?>">
                            <i class="fas fa-trash"></i>
                        </a>
                        <?php if ($insp['estado'] === 'completo'): ?>
                            <a href="<?= site_url('inspecciones/inspeccion-locativa/view/' . $insp['id']) ?>" class="btn btn-sm btn-outline-dark">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="<?= site_url('inspecciones/inspeccion-locativa/pdf/' . $insp['id']) ?>" class="btn btn-sm btn-outline-success" target="_blank">
