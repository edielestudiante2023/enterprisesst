...
<body>
        ...
        <tr>
            ...
            <td rowspan="2" style="width:130px; border:1px solid #333; padding:0; vertical-align:middle;">
                <table style="width:100%; border-collapse:collapse;" cellpadding="0" cellspacing="0">
                    <tr><td style="border-bottom:1px solid #333; padding:3px 6px; font-size:8pt;"><span style="font-weight:bold;">Codigo:</span> FT-SST-235</td></tr>
    ...
    <div class="seccion">
        ...
        <div class="seccion-contenido">
            <p>La inspeccion de Elementos de Proteccion Personal (EPP) es una herramienta del Sistema de Gestion de Seguridad y Salud en el Trabajo (SG-SST) cuyo proposito es verificar el estado, uso correcto, vigencia y disponibilidad de los EPP entregados a los trabajadores. La identificacion oportuna de fallas en la dotacion permite prevenir accidentes laborales y reducir la exposicion a peligros.</p>
            <p>El proceso de inspeccion contribuye al cumplimiento de la Resolucion 0312 de 2019, el Decreto 1072 de 2015 y la Ley 1562 de 2012, asi como al fortalecimiento de la cultura preventiva y la mejora continua del sistema de gestion.</p>
        </div>
    </div>

    <div class="seccion">
        <div class="seccion-titulo">ALCANCE DE LA INSPECCION</div>
        <div class="seccion-contenido">
            <p>Durante la inspeccion se evalua: (a) el estado fisico de los EPP (ausencia de roturas, desgaste, deterioro), (b) el uso correcto por parte del trabajador, (c) la vigencia y conservacion de los elementos certificados, (d) la disponibilidad de tallas y reposicion oportuna y (e) la idoneidad del EPP para el riesgo al cual se expone el trabajador. Cada hallazgo se documenta con evidencia fotografica del incumplimiento y de la correccion implementada.</p>
        </div>
    </div>

    <div class="seccion">
        <div class="seccion-titulo">ENFOQUE PREVENTIVO</div>
        <div class="seccion-contenido">
            <p>Los hallazgos clasificados como ABIERTOS requieren intervencion por parte del empleador dentro de los plazos acordados (reposicion del EPP, capacitacion al trabajador, ajuste de procedimientos, etc.). Los hallazgos CERRADOS corresponden a condiciones que ya fueron corregidas y verificadas. A continuacion se detallan los hallazgos registrados durante esta inspeccion.</p>
        </div>
    </div>
    ...
    <div class="seccion">
        ...
        <table class="tabla-contenido">
            <thead>
                <tr>
                    <th style="width:4%;">#</th>
                    <th style="width:30%;">EPP / TRABAJADOR / DESCRIPCION</th>
                    <th style="width:23%;">IMAGEN HALLAZGO</th>
                    <th style="width:23%;">IMAGEN CORRECCION</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if (!empty($h['tipo_epp'])): ?>
                            <strong><?= esc($h['tipo_epp']) ?></strong><br>
                        <?php endif; ?>
                        <?php if (!empty($h['trabajador_area'])): ?>
                            <em style="font-size:8pt; color:#555;"><?= esc($h['trabajador_area']) ?></em><br>
                        <?php endif; ?>
                        <?= esc($h['descripcion']) ?>
    ...
    <div class="seccion">
        <div class="seccion-titulo">OBSERVACIONES Y RECOMENDACIONES</div>
