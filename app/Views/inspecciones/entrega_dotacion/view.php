<div class="container-fluid px-3">
    <div class="mt-2 mb-3 d-flex justify-content-between align-items-center">
        ...
        <span class="badge badge-<?= esc($entrega['estado']) ?>">
        ...
        <div class="card-body">
            ...
            <?php else: ?>
                ...
                <div class="mb-3 pb-2" style="border-bottom:1px solid #eee;">
                    ...
                    <?php if (!empty($a['firma_path'])): ?>
                    <div class="mt-2">
                        <a href="<?= site_url('inspecciones/entrega-dotacion/pdf-operario/' . $a['id']) ?>" class="btn btn-sm btn-outline-success" target="_blank">
                            <i class="fas fa-file-pdf"></i> PDF de este operario
                        </a>
                    </div>
                    <?php endif; ?>
                </div>
    ...
    <div class="mb-4 d-grid gap-2">
        <?php if ($entrega['estado'] === 'borrador'): ?>
        <a href="<?= site_url('inspecciones/entrega-dotacion/edit/' . $entrega['id']) ?>" class="btn btn-pwa btn-pwa-primary">
            <i class="fas fa-edit"></i> Continuar editando
        </a>
        <?php endif; ?>
        <a href="<?= site_url('inspecciones/entrega-dotacion') ?>" class="btn btn-pwa btn-pwa-outline">
