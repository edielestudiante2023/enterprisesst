<div class="container-fluid px-3">
    ...
    <div class="mb-4 d-grid gap-2">
        ...
        <a href="<?= site_url('inspecciones/lista-asistencia/pdf/' . $lista['id']) ?>" class="btn btn-pwa btn-pwa-primary" target="_blank">
            <i class="fas fa-file-pdf"></i> Ver PDF
        </a>
        <?php endif; ?>
        <?php if ($lista['estado'] === 'borrador'): ?>
        <a href="<?= site_url('inspecciones/lista-asistencia/edit/' . $lista['id']) ?>" class="btn btn-pwa btn-pwa-primary">
            <i class="fas fa-edit"></i> Continuar editando
        </a>
        <?php endif; ?>
        <a href="<?= site_url('inspecciones/lista-asistencia') ?>" class="btn btn-pwa btn-pwa-outline">
