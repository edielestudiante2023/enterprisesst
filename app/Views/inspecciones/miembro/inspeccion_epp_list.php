<div class="container-fluid px-3">
    <div class="d-flex justify-content-between align-items-center mt-2 mb-3">
        ...
        <a href="<?= site_url('miembro/inspecciones/inspeccion-epp/create') ?>" class="btn btn-sm btn-pwa-primary" style="width:auto; padding: 8px 16px;">
    ...
    <?php if (empty($inspecciones)): ?>
        <div class="text-center text-muted py-5">
            ...
            <p>No hay inspecciones de EPP aun</p>
            <a href="<?= site_url('miembro/inspecciones/inspeccion-epp/create') ?>" class="btn btn-pwa-primary" style="width:auto; padding: 8px 24px;">
            ...
            <div class="card card-inspeccion <?= esc($insp['estado']) ?>">
                <div class="card-body py-3 px-3">
                    ...
                    <div class="mt-2 d-flex gap-2 flex-wrap">
                        ...
                        <a href="<?= site_url('miembro/inspecciones/inspeccion-epp/edit/' . $insp['id']) ?>" class="btn btn-sm btn-outline-dark">
                            <i class="fas fa-edit"></i> Editar
                        </a>
                        <?php endif; ?>
                        <?php if ($insp['estado'] === 'completo'): ?>
                            <a href="<?= site_url('miembro/inspecciones/inspeccion-epp/view/' . $insp['id']) ?>" class="btn btn-sm btn-outline-dark">
                                <i class="fas fa-eye"></i> Ver
                            </a>
                            <a href="<?= site_url('miembro/inspecciones/inspeccion-epp/pdf/' . $insp['id']) ?>" class="btn btn-sm btn-outline-success" target="_blank">
