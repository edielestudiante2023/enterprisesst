            ...
            <div class="mb-3 pb-3" style="border-bottom:1px solid #eee;">
                ...
                <div class="row g-2 mb-2">
                    ...
                    <div class="col-6">
                        ...
                        <img src="<?= base_url($h['imagen']) ?>" class="img-fluid rounded"
                    ...
                    <div class="col-6">
                        ...
                        <img src="<?= base_url($h['imagen_correccion']) ?>" class="img-fluid rounded"
                             style="width:100%; height:120px; object-fit:cover; cursor:pointer; border:1px solid #ddd;"
                             onclick="openPhoto(this.src, 'Correccion #<?= $i + 1 ?>')">
                    </div>
                    <?php endif; ?>
                </div>
