<div class="container-fluid px-3">
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <table class="table table-sm mb-0" style="font-size:14px;">
                ...
                <tr>
                    <td class="text-muted">Realizada por</td>
                    <td>
    ...
    <div class="mb-4 d-grid gap-2">
        ...
        <a href="<?= site_url('miembro/inspecciones/inspeccion-epp/pdf/' . $inspeccion['id']) ?>" class="btn btn-pwa btn-pwa-primary" target="_blank">
            <i class="fas fa-file-pdf"></i> Ver PDF
        </a>
        <?php endif; ?>
        <?php if ($inspeccion['estado'] === 'borrador'): ?>
        <a href="<?= site_url('miembro/inspecciones/inspeccion-epp/edit/' . $inspeccion['id']) ?>" class="btn btn-pwa btn-pwa-primary">
            <i class="fas fa-edit"></i> Continuar editando
        </a>
        <?php endif; ?>
        <a href="<?= site_url('miembro/inspecciones/inspeccion-epp') ?>" class="btn btn-pwa btn-pwa-outline">
