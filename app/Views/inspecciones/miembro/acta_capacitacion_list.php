                ...
                <div class="card-body py-3 px-3">
                    <div class="d-flex justify-content-between align-items-start">
                        <div style="flex:1;">
                            ...
                            <div class="text-muted" style="font-size:13px;">
                                <i class="fas fa-user"></i> <?= esc($a['nombre_creador'] ?? '') ?>
                            </div>
                    ...
                    <div class="mt-2 d-flex gap-2 flex-wrap">
                        <?php if ($a['estado'] === 'borrador' && $a['creado_por_tipo'] === 'miembro' && (int)$a['id_miembro'] === (int)$miembro['id_miembro']): ?>
                            <a href="<?= site_url('miembro/acta-capacitacion/edit/' . $a['id']) ?>" class="btn btn-sm btn-outline-dark">
                                <i class="fas fa-edit"></i> Editar
                            </a>
                        <?php endif; ?>
                        <a href="<?= site_url('miembro/acta-capacitacion/view/' . $a['id']) ?>" class="btn btn-sm btn-outline-dark">
                            <i class="fas fa-eye"></i> Ver
                        </a>
                        <?php if ($a['estado'] === 'completo'): ?>
                            <a href="<?= site_url('miembro/acta-capacitacion/pdf/' . $a['id']) ?>" class="btn btn-sm btn-outline-success" target="_blank">
