...
<head>
    ...
    <title>Generador PyP Salud - <?= esc($cliente['nombre_cliente']) ?></title>
...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class="bi bi-heart-pulse me-2"></i>Generador IA - PyP Salud
            </a>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="mb-1">Programa de Promocion y Prevencion en Salud</h4>
                <p class="text-muted mb-0">Estandar 3.1.2 - Resolucion 0312/2019</p>
            </div>
            <div>
        ...
        <div class="alert alert-info mb-4">
            ...
            <strong>Flujo de generacion del Programa PyP Salud:</strong>
            <ol class="mb-0 mt-2">
                <li><strong>Actividades PyP Salud</strong> - Se generan actividades de promocion y prevencion en el PTA</li>
                <li><strong>Indicadores PyP Salud</strong> - Se configuran indicadores para medir el programa</li>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                <h6 class="mb-0">
                    ...
                    <small class="text-muted ms-2">La IA usara esta informacion para generar actividades de PyP salud personalizadas</small>
                </h6>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea id="instruccionesIA" class="form-control" rows="3"
                                placeholder="Ej: No incluir examenes medicos porque ya se hicieron el ano pasado, enfocarse en riesgo psicosocial, agregar campanas de salud mental..."></textarea>
                            <small class="text-muted">
                                Describa necesidades especificas de la empresa para personalizar las actividades de PyP Salud.
                            </small>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <!-- Paso 1: Actividades PyP Salud -->
            <div class="col-md-6 mb-4">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header bg-danger text-white">
                        <h5 class="mb-0">
                            <span class="badge bg-white text-danger me-2">1</span>
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-light small mb-3">
                            ...
                            <ul class="mb-0 mt-1">
                                ...
                                <li>Campanas de promocion de salud</li>
                                <li>Capacitaciones en estilos de vida saludables</li>
                                <li>Seguimiento a casos de salud</li>
                        ...
                        <div class="d-grid gap-2">
                            <button type="button" class="btn btn-outline-danger" onclick="previewActividades()">
                                <i class="bi bi-eye me-1"></i>Ver Preview
                            </button>
                            <button type="button" class="btn btn-danger" onclick="generarActividades()">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-between mb-1">
                                ...
                                <strong><?= $verificacionIndicadores['minimo'] ?></strong>
                            </div>
                            <?php if ($verificacionIndicadores['completo']): ?>
                                <div class="alert alert-success small mb-0 mt-2">
                                    <i class="bi bi-check-circle me-1"></i>Fase completa
                                </div>
                            <?php else: ?>
                        ...
                        <div class="alert alert-light small mb-3">
                            ...
                            <ul class="mb-0 mt-1">
                                <li>Cobertura de examenes medicos periodicos</li>
                                <li>Cumplimiento de actividades de PyP</li>
                                <li>Tasa de enfermedad laboral</li>
                                <li>Participacion en capacitaciones de salud</li>
                            </ul>
                        </div>
                        ...
                        <div class="d-grid">
                            <a href="<?= base_url('indicadores-sst/' . $cliente['id_cliente']) ?>"
                               ...
                               <?= !$resumenActividades['completo'] ? 'onclick="alert(\'Primero genere las actividades de PyP Salud\'); return false;"' : '' ?>>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white">
                <h5 class="mb-0">
                    <i class="bi bi-list-check me-2"></i>Actividades de PyP Salud en el PTA (<?= count($actividadesExistentes) ?>)
                </h5>
            </div>
        ...
        <!-- Modal Preview con selección -->
        <div class="modal fade" id="modalPreview" tabindex="-1">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title"><i class="bi bi-eye me-2"></i>Seleccionar Actividades PyP Salud</h5>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <div>
                            ...
                            <button type="button" class="btn btn-danger" id="btnGenerarSeleccionadas" onclick="generarActividadesSeleccionadas()">
    ...
    function previewActividades() {
        ...
        fetch(`<?= base_url('generador-ia') ?>/${idCliente}/preview-actividades-pyp?anio=${anio}&instrucciones=${instrucciones}`)
            .then(r => r.json())
            .then(data => {
                if (data.success) {
    ...
    function renderPreviewTable() {
        // Mostrar explicación de la IA si existe
        let explicacionHtml = '';
        if (explicacionIA) {
            explicacionHtml = `
                <div class="alert alert-success small mb-3">
                    <i class="bi bi-robot me-2"></i><strong>IA aplicó cambios:</strong> ${explicacionIA}
                </div>`;
        }
        ...
        let html = `
            ...
            <div class="alert alert-light small mb-3 border">
                ...
                <div class="mt-2">
                    <span class="badge bg-secondary me-1">Base</span> Actividades estándar
                    <span class="badge bg-warning text-dark ms-2 me-1">Peligro</span> Según peligros identificados
    ...
    function generarActividadesSeleccionadas() {
        ...
        if (!confirm(`¿Generar ${seleccionadas.length} actividades de PyP Salud en el PTA?`)) return;

        const btn = document.getElementById('btnGenerarSeleccionadas');
        btn.disabled = true;
        btn.innerHTML = '<span class="spinner-border spinner-border-sm me-1"></span>Generando...';

        fetch(`<?= base_url('generador-ia') ?>/${idCliente}/generar-actividades-pyp`, {
            method: 'POST',
