                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-sm table-borderless">
                                ...
                                <tr>
                                    <td class="text-muted">Código CIIU:</td>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-info"><?= $contexto['estandares_aplicables'] ?? '60' ?> estándares</span></td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea id="instruccionesIA" class="form-control" rows="3"
                                placeholder="Ej: No incluir exámenes médicos porque ya se hicieron el año pasado, enfocarse en riesgo psicosocial, agregar campañas de salud mental..."></textarea>
                            <small class="text-muted">
                                Describa necesidades específicas de la empresa para personalizar las actividades de PyP Salud.
                            </small>
                        </div>
                    </div>
                </div>
