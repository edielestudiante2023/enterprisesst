<!--
  GOLD STANDARD — Vista Parte 2 (Indicadores) del Programa de Inspecciones.
...
<head>
    ...
    <title>Indicadores Programa Inspecciones - <?= esc($cliente['nombre_cliente']) ?></title>
...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class="bi bi-search me-2"></i>Indicadores Programa de Inspecciones
            </a>
            <div class="navbar-nav ms-auto">
                <span class="navbar-text text-white me-3">
                    <i class="bi bi-building me-1"></i><?= esc($cliente['nombre_cliente']) ?>
                </span>
                <a href="<?= base_url('generador-ia/' . $cliente['id_cliente'] . '/programa-inspecciones') ?>" class="btn btn-outline-light btn-sm">
    ...
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="mb-1">Indicadores del Programa de Inspecciones</h4>
                <p class="text-muted mb-0">Parte 2 - Estandar 4.2.4 - Resolucion 0312/2019</p>
            </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white">
                <h6 class="mb-0"><i class="bi bi-graph-up text-success me-2"></i>Indicadores de Inspecciones (<?= count($indicadoresExistentes) ?>)</h6>
            </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                <p class="text-muted">Se generaran indicadores para medir el programa de inspecciones a instalaciones, maquinaria y equipos.</p>
                <div class="d-flex gap-2">
                    ...
                    <button type="button" class="btn btn-primary" id="btnGenerarInd" onclick="generarIndicadores()" disabled>
    ...
    async function previewIndicadores() {
        ...
        try {
            const response = await fetch(`<?= base_url('generador-ia') ?>/${idCliente}/preview-indicadores-inspecciones`);
            ...
            if (data.success) {
                ...
                showAlert('danger', data.data?.error || data.message || 'Error al cargar preview');
            }
        } catch (error) {
    ...
    async function generarIndicadores() {
        ...
        try {
            const response = await fetch(`<?= base_url('generador-ia') ?>/${idCliente}/generar-indicadores-inspecciones`, {
                method: 'POST',
