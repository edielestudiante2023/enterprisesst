...
<head>
    ...
    <title>Generador IA - Indicadores Estilos de Vida Saludable - <?= esc($cliente['nombre_cliente']) ?></title>
...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class="bi bi-graph-up me-2"></i>Generador IA - Indicadores Estilos de Vida Saludable
            </a>
            <div class="navbar-nav ms-auto">
                ...
                <a href="<?= base_url('generador-ia/' . $cliente['id_cliente'] . '/estilos-vida-saludable') ?>" class="btn btn-outline-light btn-sm">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="mb-1">Indicadores de Estilos de Vida Saludable</h4>
                <p class="text-muted mb-0">Estandar 3.1.7 - Resolucion 0312/2019</p>
            </div>
            <div>
        ...
        <div class="alert alert-info mb-4">
            ...
            <strong>Indicadores para medir el programa de estilos de vida saludable, controles de tabaquismo, alcoholismo y farmacodependencia:</strong>
            <ol class="mb-0 mt-2">
                <li><strong>Cumplimiento de actividades</strong> - Mide la ejecucion de actividades del programa</li>
                <li><strong>Cobertura de participacion</strong> - Mide el alcance de las campanas de prevencion</li>
                <li><strong>Indicadores de resultado</strong> - Variacion en consumo, ausentismo, casos remitidos, etc.</li>
            </ol>
        </div>
            ...
            <div class="col-md-8 mb-4">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">
                            <i class="bi bi-graph-up me-2"></i>Indicadores de Estilos de Vida Saludable
                        </h5>
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($resumenIndicadores['completo']): ?>
                            <div class="alert alert-success">
                                ...
                                <strong>Fase completa:</strong> Ya tiene <?= $resumenIndicadores['existentes'] ?> indicadores de Estilos de Vida Saludable configurados.
                            </div>
                        <?php else: ?>
                        ...
                        <div class="alert alert-light border mb-3">
                            ...
                            <ul class="mb-0 mt-2 small">
                                <li><strong>Cumplimiento de actividades del programa</strong></li>
                                <li><strong>Cobertura de participacion en campanas</strong></li>
                                <li><strong>Numero de campanas de prevencion realizadas</strong></li>
                                <li><strong>Variacion en porcentaje de fumadores activos</strong></li>
                                <li><strong>Tasa de ausentismo por enfermedades cronicas</strong></li>
                                <li><strong>Satisfaccion de trabajadores con el programa</strong></li>
                                <li><strong>Casos remitidos a EPS por consumo de SPA</strong></li>
                            </ul>
                        </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white">
                <h5 class="mb-0">
                    <i class="bi bi-list-check me-2"></i>Indicadores de Estilos de Vida Saludable Configurados (<?= count($indicadoresExistentes) ?>)
                </h5>
            </div>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title"><i class="bi bi-eye me-2"></i>Seleccionar Indicadores Estilos de Vida Saludable</h5>
    ...
    function previewIndicadores() {
        ...
        fetch(`<?= base_url('generador-ia') ?>/${idCliente}/preview-indicadores-estilos-vida`)
            .then(r => r.json())
            .then(data => {
                if (data.success) {
    ...
    function generarIndicadoresSeleccionados() {
        ...
        if (!confirm(`¿Generar ${seleccionados.length} indicadores de Estilos de Vida Saludable?`)) return;

        const btn = document.getElementById('btnGenerarSeleccionados');
        btn.disabled = true;
        btn.innerHTML = '<span class="spinner-border spinner-border-sm me-1"></span>Generando...';

        fetch(`<?= base_url('generador-ia') ?>/${idCliente}/generar-indicadores-estilos-vida`, {
            method: 'POST',
