...
<head>
    ...
    <title>Generador IA - Indicadores Evaluaciones Medicas Ocupacionales - <?= esc($cliente['nombre_cliente']) ?></title>
...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class="bi bi-clipboard2-pulse me-2"></i>Generador IA - Indicadores Evaluaciones Medicas Ocupacionales
            </a>
            <div class="navbar-nav ms-auto">
                ...
                <a href="<?= base_url('generador-ia/' . $cliente['id_cliente'] . '/evaluaciones-medicas-ocupacionales') ?>" class="btn btn-outline-light btn-sm">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="mb-1">Indicadores de Evaluaciones Medicas Ocupacionales</h4>
        ...
        <div class="alert alert-info mb-4">
            ...
            <strong>Indicadores de evaluaciones medicas ocupacionales, cobertura, cumplimiento de profesiograma, comunicacion de resultados:</strong>
            <ol class="mb-0 mt-2">
                <li><strong>Cobertura de evaluaciones medicas</strong> - Mide el porcentaje de trabajadores evaluados</li>
                <li><strong>Cumplimiento de profesiograma</strong> - Mide la ejecucion de examenes segun perfil de cargo</li>
                <li><strong>Comunicacion de resultados</strong> - Mide la entrega oportuna de resultados a trabajadores</li>
            </ol>
        </div>
            ...
            <div class="col-md-8 mb-4">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">
                            <i class="bi bi-clipboard2-pulse me-2"></i>Indicadores de Evaluaciones Medicas Ocupacionales
                        </h5>
                        <span class="badge bg-light text-success"><?= $resumenIndicadores['existentes'] ?> configurados</span>
                    </div>
                    <div class="card-body">
                        <!-- Estado actual -->
                        <div class="row mb-4">
                            <div class="col-md-4">
                                <div class="border rounded p-3 text-center">
                                    <h3 class="mb-0 text-success"><?= $resumenIndicadores['existentes'] ?></h3>
                                    <small class="text-muted">Indicadores existentes</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="border rounded p-3 text-center">
                                    <h3 class="mb-0 text-info"><?= $resumenIndicadores['limite'] ?? 7 ?></h3>
                        ...
                        <?php if ($resumenIndicadores['completo']): ?>
                            <div class="alert alert-success">
                                ...
                                <strong>Fase completa:</strong> Ya tiene <?= $resumenIndicadores['existentes'] ?> indicadores de Evaluaciones Medicas Ocupacionales configurados.
                            </div>
                        <?php else: ?>
                        ...
                        <div class="alert alert-light border mb-3">
                            ...
                            <ul class="mb-0 mt-2 small">
                                <li><strong>Cobertura de evaluaciones medicas ocupacionales</strong></li>
                                <li><strong>Cumplimiento del profesiograma</strong></li>
                                <li><strong>Comunicacion oportuna de resultados medicos</strong></li>
                                <li><strong>Cumplimiento de examenes de ingreso</strong></li>
                                <li><strong>Cumplimiento de examenes periodicos</strong></li>
                                <li><strong>Cumplimiento de examenes de retiro</strong></li>
                                <li><strong>Seguimiento a recomendaciones medico-laborales</strong></li>
                            </ul>
                        </div>

                        <!-- Botones -->
                        <div class="d-grid gap-2">
                            <button type="button" class="btn btn-outline-success" onclick="previewIndicadores()">
                                <i class="bi bi-eye me-1"></i>Ver Preview de Indicadores
                            </button>
                            <button type="button" class="btn btn-success" onclick="previewIndicadores()">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white">
                <h5 class="mb-0">
                    <i class="bi bi-list-check me-2"></i>Indicadores de Evaluaciones Medicas Ocupacionales Configurados (<?= count($indicadoresExistentes) ?>)
                </h5>
            </div>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title"><i class="bi bi-eye me-2"></i>Seleccionar Indicadores Evaluaciones Medicas Ocupacionales</h5>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <div>
                            ...
                            <button type="button" class="btn btn-success" id="btnGenerarSeleccionados" onclick="generarIndicadoresSeleccionados()">
    ...
    function showToast(type, title, message) {
        ...
        if (type === 'success') {
            ...
            toastIcon.className = 'bi bi-info-circle-fill text-success me-2';
            toast.classList.add('border-success');
        }
    ...
    function previewIndicadores() {
        ...
        fetch(`<?= base_url('generador-ia') ?>/${idCliente}/preview-indicadores-evaluaciones-medicas`)
            .then(r => r.json())
            .then(data => {
                if (data.success) {
    ...
    function renderPreviewTable() {
        let html = `
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div>
                    <button type="button" class="btn btn-sm btn-outline-success me-1" onclick="seleccionarTodos(true)">
            ...
            <div class="alert alert-light small border mb-3">
                ...
                <div class="mt-2">
                    ...
                    <span class="badge bg-danger ms-2 me-1">Resultado</span> Miden impacto en salud
                </div>
            </div>
            <div class="table-responsive">
            ...
            html += `
                <tr class="${rowClass}">
                    ...
                    <td>
                        ...
                        ${ind.peligro_relacionado ? `<small class="d-block text-warning"><i class="bi bi-exclamation-triangle me-1"></i>${ind.peligro_relacionado}</small>` : ''}
                    ...
                    <td>
                        <span class="badge bg-${ind.origen === 'peligro' ? 'warning text-dark' : 'secondary'}">
                            ${ind.origen === 'peligro' ? 'Peligro' : 'Base'}
                        </span>
                    </td>
                </tr>`;
        });
    ...
    function generarIndicadoresSeleccionados() {
        ...
        if (!confirm(`¿Generar ${seleccionados.length} indicadores de Evaluaciones Medicas Ocupacionales?`)) return;

        const btn = document.getElementById('btnGenerarSeleccionados');
        btn.disabled = true;
        btn.innerHTML = '<span class="spinner-border spinner-border-sm me-1"></span>Generando...';

        fetch(`<?= base_url('generador-ia') ?>/${idCliente}/generar-indicadores-evaluaciones-medicas`, {
            method: 'POST',
