...
<head>
    ...
    <title>Generador Estilos de Vida Saludable - <?= esc($cliente['nombre_cliente']) ?></title>
...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class="bi bi-tree me-2"></i>Generador IA - Estilos de Vida Saludable
            </a>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="mb-1">Programa de Estilos de Vida Saludable y Entornos Saludables</h4>
        ...
        <div class="alert alert-info mb-4">
            ...
            <strong>Flujo de generacion del Programa de Estilos de Vida Saludable:</strong>
            <ol class="mb-0 mt-2">
                <li><strong>Actividades Estilos de Vida Saludable</strong> - Se generan actividades de promocion de estilos de vida y entornos saludables, incluyendo controles de tabaquismo, alcoholismo y farmacodependencia en el PTA</li>
                <li><strong>Indicadores Estilos de Vida Saludable</strong> - Se configuran indicadores para medir el programa</li>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                <h6 class="mb-0">
                    ...
                    <small class="text-muted ms-2">La IA usara esta informacion para generar actividades de estilos de vida saludable personalizadas</small>
                </h6>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea id="instruccionesIA" class="form-control" rows="3"
                                placeholder="Ej: No incluir campanas de tabaquismo porque la empresa ya es libre de humo, enfocarse en alimentacion saludable, agregar actividades deportivas..."></textarea>
                            <small class="text-muted">
                                Describa necesidades especificas de la empresa para personalizar las actividades de Estilos de Vida Saludable.
                            </small>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <!-- Paso 1: Actividades Estilos de Vida Saludable -->
            <div class="col-md-6 mb-4">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header bg-success text-white">
                        <h5 class="mb-0">
                            <span class="badge bg-white text-success me-2">1</span>
                            Actividades de Estilos de Vida Saludable
                        </h5>
                    </div>
                    <div class="card-body">
                        <!-- Estado actual -->
                        ...
                        <div class="alert alert-light small mb-3">
                            ...
                            <ul class="mb-0 mt-1">
                                <li>Campanas de prevencion tabaquismo, alcoholismo, farmacodependencia</li>
                                <li>Actividades de alimentacion saludable</li>
                                <li>Jornadas deportivas y pausas activas</li>
                                <li>Talleres de manejo del estres</li>
                                <li>Encuestas de habitos de vida</li>
                            </ul>
                        </div>
                ...
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <?php else: ?>
                                <div class="alert alert-warning small mb-0 mt-2">
                                    <i class="bi bi-exclamation-triangle me-1"></i>Primero genere las actividades de Estilos de Vida Saludable
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="alert alert-light small mb-3">
                            ...
                            <ul class="mb-0 mt-1">
                                <li>Cumplimiento de actividades del programa</li>
                                <li>Cobertura de participacion en campanas</li>
                                <li>Variacion en porcentaje de fumadores</li>
                                <li>Satisfaccion con el programa</li>
                            </ul>
                        </div>

                        <!-- Boton -->
                        <div class="d-grid">
                            <a href="<?= base_url('generador-ia/' . $cliente['id_cliente'] . '/indicadores-estilos-vida') ?>"
                               class="btn btn-<?= $resumenActividades['completo'] ? 'primary' : 'secondary' ?>"
                               <?= !$resumenActividades['completo'] ? 'onclick="alert(\'Primero genere las actividades de Estilos de Vida Saludable\'); return false;"' : '' ?>>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white">
                <h5 class="mb-0">
                    <i class="bi bi-list-check me-2"></i>Actividades de Estilos de Vida Saludable en el PTA (<?= count($actividadesExistentes) ?>)
                </h5>
            </div>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title"><i class="bi bi-eye me-2"></i>Seleccionar Actividades Estilos de Vida Saludable</h5>
    ...
    function previewActividades() {
        ...
        fetch(`<?= base_url('generador-ia') ?>/${idCliente}/preview-actividades-estilos-vida?anio=${anio}&instrucciones=${instrucciones}`)
            .then(r => r.json())
            .then(data => {
                if (data.success) {
    ...
    function generarActividadesSeleccionadas() {
        ...
        if (!confirm(`¿Generar ${seleccionadas.length} actividades de Estilos de Vida Saludable en el PTA?`)) return;

        const btn = document.getElementById('btnGenerarSeleccionadas');
        btn.disabled = true;
        btn.innerHTML = '<span class="spinner-border spinner-border-sm me-1"></span>Generando...';

        fetch(`<?= base_url('generador-ia') ?>/${idCliente}/generar-actividades-estilos-vida`, {
            method: 'POST',
