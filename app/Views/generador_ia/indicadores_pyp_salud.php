...
<head>
    ...
    <title>Indicadores PyP Salud - <?= esc($cliente['nombre_cliente']) ?></title>
...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class="bi bi-graph-up me-2"></i>Generador IA - Indicadores PyP Salud
            </a>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="mb-1">Indicadores de Promocion y Prevencion en Salud</h4>
        ...
        <div class="alert alert-info mb-4">
            ...
            <strong>Indicadores para medir el Programa de PyP Salud:</strong>
            <ol class="mb-0 mt-2">
                <li><strong>Cobertura de examenes medicos</strong> - Mide el porcentaje de trabajadores evaluados</li>
                <li><strong>Cumplimiento de actividades</strong> - Mide la ejecucion de actividades de PyP</li>
                <li><strong>Indicadores de resultado</strong> - Tasa de enfermedad laboral, ausentismo, etc.</li>
            </ol>
        </div>
            ...
            <div class="col-md-8 mb-4">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">
                            <i class="bi bi-graph-up me-2"></i>Indicadores de PyP Salud
                        </h5>
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($resumenIndicadores['completo']): ?>
                            <div class="alert alert-success">
                                ...
                                <strong>Fase completa:</strong> Ya tiene <?= $resumenIndicadores['existentes'] ?> indicadores de PyP Salud configurados.
                            </div>
                        <?php else: ?>
                        ...
                        <div class="alert alert-light border mb-3">
                            ...
                            <ul class="mb-0 mt-2 small">
                                <li><strong>Cobertura de Examenes Medicos</strong> - Meta: 100%</li>
                                <li><strong>Cumplimiento de Actividades PyP</strong> - Meta: 90%</li>
                                <li><strong>Tasa de Incidencia de Enfermedad Laboral</strong></li>
                                <li><strong>Tasa de Ausentismo por Causa Medica</strong></li>
                                <li><strong>Participacion en Actividades de Salud</strong></li>
                            </ul>
                        </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white">
                <h5 class="mb-0">
                    <i class="bi bi-list-check me-2"></i>Indicadores de PyP Salud Configurados (<?= count($indicadoresExistentes) ?>)
                </h5>
            </div>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title"><i class="bi bi-eye me-2"></i>Seleccionar Indicadores PyP Salud</h5>
    ...
    function previewIndicadores() {
        ...
        fetch(`<?= base_url('generador-ia') ?>/${idCliente}/preview-indicadores-pyp`)
            .then(r => r.json())
            .then(data => {
                if (data.success) {
        ...
        let html = `
            ...
            <div class="alert alert-light small border mb-3">
                ...
                <div class="mt-2">
                    ...
                    <span class="badge bg-primary ms-2 me-1">Proceso</span> Miden ejecucion de actividades
    ...
    function generarIndicadoresSeleccionados() {
        ...
        if (!confirm(`¿Generar ${seleccionados.length} indicadores de PyP Salud?`)) return;

        const btn = document.getElementById('btnGenerarSeleccionados');
        btn.disabled = true;
        btn.innerHTML = '<span class="spinner-border spinner-border-sm me-1"></span>Generando...';

        fetch(`<?= base_url('generador-ia') ?>/${idCliente}/generar-indicadores-pyp`, {
            method: 'POST',
