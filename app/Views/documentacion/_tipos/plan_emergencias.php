...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-danger text-white">
        <h6 class="mb-0">
            <i class="bi bi-exclamation-triangle me-2"></i>Soportes Plan de Emergencias
        </h6>
    </div>
    <div class="card-body">
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php foreach ($documentosSSTAprobados as $soporte): ?>
                            ...
                            ?>
                            <tr>
                                <td><code><?= esc($soporte['codigo'] ?? 'SOP-EME') ?></code></td>
                                <td>
        ...
        <?php else: ?>
            <div class="text-center py-4">
                ...
                <p class="text-muted mt-2 mb-0">No hay soportes del plan de emergencias adjuntados aun.</p>
