<?php
/**
 * Vista de Tipo: 3.1.9 Eliminacion adecuada de residuos solidos, liquidos o gaseosos
...
<div class="alert alert-success mb-4">
    <div class="d-flex align-items-start">
        ...
        <div>
            <h6 class="mb-1">Eliminacion Adecuada de Residuos Solidos, Liquidos o Gaseosos</h6>
            <p class="mb-0 small">Adjunte soportes de gestion de residuos: contratos con gestores, certificados de disposicion final, manifiestos de transporte, PGIRS, registros de separacion, etc.</p>
        </div>
    </div>
</div>

<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-success text-white"><h6 class="mb-0"><i class="bi bi-recycle me-2"></i>Soportes Gestion de Residuos</h6></div>
    <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><code><?= esc($s['codigo'] ?? 'SOP-RES') ?></code></td>
        ...
        <?php else: ?>
            <div class="text-center py-4"><i class="bi bi-recycle text-muted" style="font-size:2.5rem"></i><p class="text-muted mt-2 mb-0">No hay soportes adjuntados aun.</p></div>
        <?php endif; ?>
    </div>
</div>
...
<div class="modal fade" id="modalAdjuntar" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('documentos-sst/adjuntar-soporte-residuos') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3"><label class="form-label">Descripcion</label><input type="text" class="form-control" name="descripcion" required placeholder="Ej: Certificado disposicion final, Contrato gestor..."></div>
