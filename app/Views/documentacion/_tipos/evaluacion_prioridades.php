<?php
/**
 * Vista de Tipo: 2.3.1 Evaluacion e identificacion de prioridades
...
<div class="alert alert-warning mb-4">
    <div class="d-flex align-items-start">
        ...
        <div>
            <h6 class="mb-1">Evaluacion e Identificacion de Prioridades</h6>
            <p class="mb-0 small">Adjunte soportes de evaluacion inicial, autoevaluacion y priorizacion: resultados evaluacion inicial, matrices de priorizacion, planes de mejora, analisis de brechas, etc.</p>
        </div>
    </div>
</div>

<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-warning text-dark"><h6 class="mb-0"><i class="bi bi-list-check me-2"></i>Soportes Evaluacion y Prioridades</h6></div>
    <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><code><?= esc($s['codigo'] ?? 'SOP-EVP') ?></code></td>
        ...
        <?php else: ?>
            <div class="text-center py-4"><i class="bi bi-list-check text-muted" style="font-size:2.5rem"></i><p class="text-muted mt-2 mb-0">No hay soportes adjuntados aun.</p></div>
        <?php endif; ?>
    </div>
</div>
...
<div class="modal fade" id="modalAdjuntar" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('documentos-sst/adjuntar-soporte-evaluacion-prioridades') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3"><label class="form-label">Descripcion</label><input type="text" class="form-control" name="descripcion" required placeholder="Ej: Evaluacion inicial 2026, Matriz prioridades..."></div>
