    ...
    <div class="card-body p-0">
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php foreach ($soportes as $soporte): ?>
                            ...
                            ?>
                            <tr>
                                <td><code><?= esc($soporte['codigo'] ?? 'SOP-IAT') ?></code></td>
                                <td>
        ...
        <?php else: ?>
            <div class="text-center py-4">
                ...
                <small class="text-muted">Use el boton "Adjuntar Soporte" para agregar evidencias de investigacion de accidentes.</small>
            </div>
        <?php endif; ?>
    </div>
</div>
