<?php
/**
 * Vista de Tipo: 3.1.8 Agua potable, servicios sanitarios y disposicion de basuras
...
<div class="alert alert-info mb-4">
    <div class="d-flex align-items-start">
        <i class="bi bi-droplet me-3 fs-4"></i>
        <div>
            <h6 class="mb-1">Agua Potable, Servicios Sanitarios y Disposicion de Basuras</h6>
            <p class="mb-0 small">Adjunte soportes de suministro de agua potable, mantenimiento de servicios sanitarios, certificados de calidad del agua, registros de aseo, etc.</p>
        </div>
    </div>
</div>

<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-info text-white"><h6 class="mb-0"><i class="bi bi-droplet me-2"></i>Soportes Agua y Servicios Sanitarios</h6></div>
    <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><code><?= esc($s['codigo'] ?? 'SOP-SAN') ?></code></td>
        ...
        <?php else: ?>
            <div class="text-center py-4"><i class="bi bi-droplet text-muted" style="font-size:2.5rem"></i><p class="text-muted mt-2 mb-0">No hay soportes adjuntados aun.</p></div>
        <?php endif; ?>
    </div>
</div>
...
<div class="modal fade" id="modalAdjuntar" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-info text-white"><h5 class="modal-title"><i class="bi bi-cloud-upload me-2"></i>Adjuntar Soporte</h5><button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button></div>
            <form action="<?= base_url('documentos-sst/adjuntar-soporte-agua') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3"><label class="form-label">Descripcion</label><input type="text" class="form-control" name="descripcion" required placeholder="Ej: Certificado agua potable, Registro aseo..."></div>
