<?php
/**
 * Vista de Tipo: 4.1.4 Realizacion mediciones ambientales, quimicos, fisicos y biologicos
...
<div class="alert alert-info mb-4">
    <div class="d-flex align-items-start">
        ...
        <div>
            <h6 class="mb-1">Mediciones Ambientales: Quimicos, Fisicos y Biologicos</h6>
            <p class="mb-0 small">Adjunte informes de mediciones ambientales: sonometrias, iluminacion, calidad del aire, estudios de puesto de trabajo, mediciones de agentes quimicos, etc.</p>
        </div>
    </div>
</div>

<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-info text-white"><h6 class="mb-0"><i class="bi bi-speedometer2 me-2"></i>Soportes Mediciones Ambientales</h6></div>
    <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><code><?= esc($s['codigo'] ?? 'SOP-MED') ?></code></td>
        ...
        <?php else: ?>
            <div class="text-center py-4"><i class="bi bi-speedometer2 text-muted" style="font-size:2.5rem"></i><p class="text-muted mt-2 mb-0">No hay soportes adjuntados aun.</p></div>
        <?php endif; ?>
    </div>
</div>
...
<div class="modal fade" id="modalAdjuntar" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('documentos-sst/adjuntar-soporte-mediciones') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3"><label class="form-label">Descripcion</label><input type="text" class="form-control" name="descripcion" required placeholder="Ej: Informe sonometria 2026, Estudio iluminacion..."></div>
