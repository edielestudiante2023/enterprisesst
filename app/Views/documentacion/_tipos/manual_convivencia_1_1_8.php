...
(function () {
    ...
    function actualizarUrlTrim() {
        ...
        document.getElementById('btnIrTrimestralCoc').setAttribute('href', `${baseGenerar}/informe_trimestral_cocolab/${idClienteCocolab}?anio=${anio}&trimestre=${trim}`);
    }
    function actualizarUrlAnu() {
        const anio = document.getElementById('anuAnioCoc').value;
        document.getElementById('btnIrAnualCoc').setAttribute('href', `${baseGenerar}/informe_anual_cocolab/${idClienteCocolab}?anio=${anio}`);
    }
