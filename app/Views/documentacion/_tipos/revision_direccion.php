...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-primary text-white">
        <h6 class="mb-0">
            <i class="bi bi-briefcase me-2"></i>Soportes Revision por la Direccion
        </h6>
    </div>
    <div class="card-body">
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php foreach ($documentosSSTAprobados as $soporte): ?>
                            ...
                            ?>
                            <tr>
                                <td><code><?= esc($soporte['codigo'] ?? 'SOP-REV') ?></code></td>
                                <td>
        ...
        <?php else: ?>
            <div class="text-center py-4">
                ...
                <p class="text-muted mt-2 mb-0">No hay soportes de revision por la direccion adjuntados aun.</p>
