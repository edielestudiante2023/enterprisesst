<?php
/**
 * Vista de Tipo: 2.4.1 Plan que identifica objetivos, metas, responsabilidad, recursos con cronograma y firmado
...
<div class="alert alert-primary mb-4">
    <div class="d-flex align-items-start">
        ...
        <div>
            <h6 class="mb-1">Plan de Objetivos, Metas, Responsabilidades y Recursos</h6>
            <p class="mb-0 small">Adjunte soportes del plan de trabajo anual: plan con objetivos y metas, cronograma de actividades, asignacion de responsables, recursos asignados, firmas de aprobacion, etc.</p>
        </div>
    </div>
</div>

<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-primary text-white"><h6 class="mb-0"><i class="bi bi-bullseye me-2"></i>Soportes Plan de Trabajo</h6></div>
    <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><code><?= esc($s['codigo'] ?? 'SOP-POM') ?></code></td>
        ...
        <?php else: ?>
            <div class="text-center py-4"><i class="bi bi-bullseye text-muted" style="font-size:2.5rem"></i><p class="text-muted mt-2 mb-0">No hay soportes adjuntados aun.</p></div>
        <?php endif; ?>
    </div>
</div>
...
<div class="modal fade" id="modalAdjuntar" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('documentos-sst/adjuntar-soporte-plan-objetivos') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3"><label class="form-label">Descripcion</label><input type="text" class="form-control" name="descripcion" required placeholder="Ej: Plan trabajo 2026, Cronograma SST firmado..."></div>
