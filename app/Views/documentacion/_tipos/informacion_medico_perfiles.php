<?php
/**
 * Vista de Tipo: 3.1.3 Informacion al medico de los perfiles de cargo
...
<div class="alert alert-info mb-4">
    <div class="d-flex align-items-start">
        ...
        <div>
            <h6 class="mb-1">Informacion al Medico de los Perfiles de Cargo</h6>
            <p class="mb-0 small">Adjunte soportes de comunicacion de perfiles de cargo al medico ocupacional: profesiogramas, matrices de riesgo por cargo, descripciones de cargo, comunicaciones, etc.</p>
        </div>
    </div>
</div>

<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-info text-white"><h6 class="mb-0"><i class="bi bi-person-badge me-2"></i>Soportes Informacion Perfiles de Cargo</h6></div>
    <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><code><?= esc($s['codigo'] ?? 'SOP-IMP') ?></code></td>
        ...
        <?php else: ?>
            <div class="text-center py-4"><i class="bi bi-person-badge text-muted" style="font-size:2.5rem"></i><p class="text-muted mt-2 mb-0">No hay soportes adjuntados aun.</p></div>
        <?php endif; ?>
    </div>
</div>
...
<div class="modal fade" id="modalAdjuntar" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('documentos-sst/adjuntar-soporte-perfiles-medico') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3"><label class="form-label">Descripcion</label><input type="text" class="form-control" name="descripcion" required placeholder="Ej: Profesiograma operario, Comunicacion medico..."></div>
