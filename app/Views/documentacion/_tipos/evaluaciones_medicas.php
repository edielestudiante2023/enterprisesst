...
<div class="alert alert-success mb-4">
    <div class="d-flex align-items-start">
        ...
        <div>
            <h6 class="mb-1">Evaluaciones Medicas Ocupacionales</h6>
            <p class="mb-0 small">Adjunte soportes de examenes medicos ocupacionales: cronogramas, certificados de aptitud, conceptos medicos, comunicaciones a trabajadores, contratos con IPS, etc.</p>
        </div>
    </div>
</div>

<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-success text-white"><h6 class="mb-0"><i class="bi bi-clipboard2-pulse me-2"></i>Soportes Evaluaciones Medicas</h6></div>
    <div class="card-body">
        ...
        <?php else: ?>
            <div class="text-center py-4"><i class="bi bi-clipboard2-pulse text-muted" style="font-size:2.5rem"></i><p class="text-muted mt-2 mb-0">No hay soportes adjuntados aun.</p></div>
        <?php endif; ?>
    </div>
</div>
...
<div class="modal fade" id="modalAdjuntar" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('documentos-sst/adjuntar-soporte-evaluaciones-medicas') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3"><label class="form-label">Descripcion</label><input type="text" class="form-control" name="descripcion" required placeholder="Ej: Cronograma EMO 2026, Certificado aptitud..."></div>
