...
<head>
    ...
    <title>Documentacion SST - Resolucion 0312/2019</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="mb-0 opacity-75">Resolucion 0312 de 2019 - Sistema de Gestion de Seguridad y Salud en el Trabajo</p>
                </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <?php else: ?>
                            ...
                            <small class="text-muted mt-2 d-block">
                                ...
                                <?= count($clientes) ?> cliente(s) disponible(s). Escriba para buscar.
                            </small>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <a href="<?= base_url('estandares/seleccionar-cliente') ?>" class="card quick-access-card border-0 shadow-sm text-decoration-none h-100">
                            <div class="card-body text-center py-4">
                                ...
                                <h6 class="text-dark mb-1">Cumplimiento Estandares</h6>
                                <small class="text-muted">7, 21 o 60 estandares segun nivel</small>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4">
