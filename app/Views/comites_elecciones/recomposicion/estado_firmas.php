...
<div class="container-fluid py-4">
        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <h4 class="mb-1">
                    ...
                    Estado de Firmas - Recomposicion #<?= $recomposicion['numero_recomposicion'] ?>
                </h4>
    ...
    <div class="dev-panel">
        <h6 class="mb-2"><i class="fas fa-flask me-2"></i>Panel de Desarrollo - Enlaces Directos</h6>
        <p class="small text-muted mb-2">Estos enlaces permiten probar las firmas sin enviar correos:</p>
        <div class="row">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="alert alert-info">
                ...
                <a href="<?= base_url("comites-elecciones/proceso/{$proceso['id_proceso']}/recomposicion/{$recomposicion['id_recomposicion']}/firmas") ?>" class="alert-link">
                    Crear solicitudes
                </a>
            </div>
            <?php else: ?>
    ...
    <div class="d-flex justify-content-between mt-4">
        <a href="<?= base_url("comites-elecciones/proceso/{$proceso['id_proceso']}/recomposicion/{$recomposicion['id_recomposicion']}") ?>"
           class="btn btn-outline-secondary">
            <i class="fas fa-arrow-left me-1"></i> Volver a Recomposicion
        </a>
        <div>
