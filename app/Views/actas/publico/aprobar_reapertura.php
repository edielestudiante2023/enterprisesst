...
<head>
    ...
    <title>Solicitud de Reapertura - Acta <?= esc($acta['numero_acta']) ?></title>
...
<body>
    <div class="reapertura-container py-4">
        <div class="text-center mb-4">
            <h4 class="text-white"><i class="bi bi-unlock me-2"></i>Solicitud de Reapertura</h4>
        </div>

        <div class="card">
            <div class="card-header text-center">
                <h5 class="mb-1">Solicitud de Reapertura de Acta</h5>
            ...
            <div class="card-body p-4">
                ...
                <div class="info-box">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <p class="mb-1"><strong>Comite:</strong> <?= esc($comite['tipo_nombre'] ?? 'Comité') ?></p>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="alert alert-danger small">
                    ...
                    <strong>Importante:</strong> Si aprueba esta solicitud, el acta volvera al estado de edicion y todas las firmas existentes seran invalidadas. El acta debera pasar nuevamente por el proceso de cierre y firma.
                </div>

                <!-- Formulario de acción -->
                <form action="<?= base_url('acta/aprobar-reapertura/' . $token) ?>" method="post" id="formReapertura">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                        <button type="button" class="btn btn-success btn-lg px-4" onclick="confirmarAccion('aprobar')">
                            <i class="bi bi-check-circle me-1"></i> Aprobar Reapertura
                        </button>
                    ...
                    <!-- Botón de confirmar rechazo (oculto por defecto) -->
    ...
    function confirmarAccion(accion) {
        const mensaje = accion === 'aprobar'
            ? 'Esta seguro de APROBAR la reapertura? Las firmas existentes seran invalidadas.'
            : 'Esta seguro de RECHAZAR la solicitud de reapertura?';

        if (confirm(mensaje)) {
            document.getElementById('inputAccion').value = accion;
            document.getElementById('formReapertura').submit();
        }
    }
    </script>
</body>
