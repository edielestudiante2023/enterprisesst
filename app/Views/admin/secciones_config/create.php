...
<?= $this->section('title') ?>Nueva Sección Config<?= $this->endSection() ?>
...
<div class="container py-4" style="max-width: 860px;">
    ...
    <div class="card shadow-sm">
        <div class="card-header py-3" style="background: linear-gradient(135deg, #1c2437 0%, #2c3e50 100%);">
            <h5 class="mb-0 text-white">
                <i class="bi bi-plus-circle me-2"></i>Nueva Sección de Documento
            </h5>
        </div>
        <div class="card-body p-4">
            <form action="<?= site_url('addSeccionConfigPost') ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        ...
                        <select name="tipo_contenido" id="tipo_contenido" class="form-select">
                            ...
                            <option value="tabla_dinamica">tabla_dinamica</option>
                ...
                <div class="mt-3 mb-3">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control"
                           required maxlength="255" placeholder="Ej: Objetivo">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="seccion_key" id="seccion_key" class="form-control font-monospace"
                           required maxlength="100" placeholder="Ej: objetivo">
                    <div class="form-text">Identificador único dentro del tipo. Ej: <code>objetivo</code>, <code>alcance</code></div>
                </div>

                <!-- Tabla dinámica tipo (condicional) -->
                <div class="mb-3" id="wrapTablaDinamica" style="display:none;">
                    ...
                    <input type="text" name="tabla_dinamica_tipo" id="tabla_dinamica_tipo" class="form-control"
                           maxlength="50" placeholder="Ej: tipos_documento, plantillas, listado_maestro">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="prompt_ia" id="prompt_ia" class="form-control font-monospace"
                              rows="5" placeholder="Prompt para la generación con IA..."></textarea>
                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="es_obligatoria"
                                   id="es_obligatoria" value="1" checked>
