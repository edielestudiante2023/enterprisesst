        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <span class="ms-3"><?= esc($cliente['nombre_cliente']) ?> - Programa PyP Salud <?= $anio ?></span>
                </div>
                <div>
        ...
        <div class="bg-white shadow documento-contenido" style="padding: 40px; max-width: 900px; margin: 0 auto;">
                    ...
                    <div class="col-md-8">
                        <div class="d-flex align-items-center gap-3 mb-2">
                            ...
                            <span class="badge <?= $estadoClass ?> estado-badge">
                                <i class="bi bi-<?= $documento['estado'] === 'aprobado' ? 'check-circle' : ($documento['estado'] === 'firmado' ? 'patch-check' : 'pencil') ?> me-1"></i>
            ...
            <table class="encabezado-formal">
                    ...
                    <td class="encabezado-info" rowspan="2">
                        <table class="encabezado-info-table">
                            <tr>
                                ...
                                <td><?= esc($documento['codigo'] ?? 'PRG-PYP-001') ?></td>
                            </tr>
                            <tr>
                ...
                <tr>
                    ...
                    <td class="encabezado-titulo-central">
                        <div class="nombre-doc"><?= esc(strtoupper($contenido['titulo'] ?? 'PROGRAMA DE PROMOCION Y PREVENCION EN SALUD')) ?></div>
                    </td>
                </tr>
            </table>
                    ...
                    <div class="seccion">
                        ...
                        <div class="seccion-contenido">
                            <?php if (isset($seccion['tipo']) && $seccion['tipo'] === 'tabla'): ?>
                                        ...
                                        <table class="table table-bordered tabla-cronograma">
                                            ...
                                            <tbody>
                                                <?php foreach ($seccion['contenido']['filas'] as $fila): ?>
                                                    <tr>
                                                        <td><?= esc($fila['mes'] ?? '') ?></td>
                                                        <td><?= esc($fila['tema'] ?? $fila['actividad'] ?? '') ?></td>
                                                        <td><?= esc($fila['duracion'] ?? $fila['frecuencia'] ?? '') ?></td>
                                                        <td><?= esc($fila['dirigido_a'] ?? $fila['responsable'] ?? '') ?></td>
                                                        <td><?= esc($fila['responsable'] ?? '') ?></td>
                                                        <td>
                                                            <?php $estado = $fila['estado'] ?? 'Programada'; ?>
                                                            <span class="badge bg-<?= $estado === 'Programada' ? 'warning' : ($estado === 'Ejecutada' ? 'success' : 'info') ?>">
                                                                <?= esc($estado) ?>
                                                            </span>
                                                        </td>
                                                    </tr>
                                ...
                                <?php else: ?>
                                    <p class="text-muted">No hay actividades programadas para este periodo.</p>
                                <?php endif; ?>
                            <?php else: ?>
                                <!-- Contenido de texto -->
