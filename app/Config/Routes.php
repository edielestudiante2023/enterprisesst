...
$routes->get('/induccion-etapas/(:num)/checklist-pta', 'InduccionEtapasController::checklistPTA/$1');
$routes->post('/induccion-etapas/(:num)/generar-pta', 'InduccionEtapasController::generarPTA/$1');
...
$routes->get('/documentos-sst/(:num)/lista', 'DocumentosSSTController::listaDocumentos/$1');
...
$routes->post('/comites-elecciones/proceso/(:num)/notificar-designados', 'ComitesEleccionesController::notificarDesignados/$1');
