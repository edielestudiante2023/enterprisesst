<?php
/**
 * Crear tabla tbl_acta_solicitudes_marcar_ausente
 * Uso: php app/SQL/crear_tabla_solicitudes_marcar_ausente.php [--prod]
 */
...
$sql = "
CREATE TABLE IF NOT EXISTS tbl_acta_solicitudes_marcar_ausente (
    ...
    INDEX idx_asistente_estado (id_asistente, estado)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
";

try {
    $pdo->exec($sql);
    echo "OK: Tabla tbl_acta_solicitudes_marcar_ausente creada.\n";
} catch (PDOException $e) {
    echo "ERROR: " . $e->getMessage() . "\n";
}

$cols = $pdo->query("SHOW COLUMNS FROM tbl_acta_solicitudes_marcar_ausente")->fetchAll(PDO::FETCH_ASSOC);
echo "\nColumnas:\n";
foreach ($cols as $col) {
