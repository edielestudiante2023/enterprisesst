...
('2.4.1', 'Plan de Trabajo Anual que identifica objetivos, metas, responsabilidad, recursos con cronograma y firmado', 'PLANEAR', 'II', 'Gestión Integral del Sistema de Gestión de la Seguridad y la Salud en el Trabajo', 2.00, 1, 1, 1, '["PLA-TRA"]'),
