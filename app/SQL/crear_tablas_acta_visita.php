<?php
/**
 * Script CLI para crear tablas del módulo Acta de Visita (Inspecciones PWA)
 * Uso: php crear_tablas_acta_visita.php [local|production]
 *
 * Crea:
...
if ($env === 'local') {
    ...
    die("Uso: php crear_tablas_acta_visita.php [local|production]\n");
}
