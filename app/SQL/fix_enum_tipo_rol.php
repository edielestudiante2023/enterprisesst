<?php
/**
 * FIX: Agregar valores faltantes al ENUM tipo_rol en tbl_cliente_responsables_sst
 * Faltan: comite_convivencia_representante_empleador, _trabajadores, suplente_empleador, _trabajadores
 *
 * USO: php app/SQL/fix_enum_tipo_rol.php [local|produccion]
 */
...
try {
    ...
    // ENUM completo con todos los valores
