...
class PoliticaAcosoLaboral extends AbstractDocumentoSST
{
    ...
    {
        $prompts = [
            'objetivo' => "Genera el objetivo de la Politica de Prevencion del Acoso Laboral.
Debe expresar el compromiso de la organizacion con:
- Prevenir conductas de acoso laboral en todas sus formas
- Proteger la dignidad y los derechos de los trabajadores
- Promover un ambiente laboral sano y respetuoso
- Establecer mecanismos de denuncia y correccion
IMPORTANTE: Maximo 2-3 parrafos concisos, mencionar Ley 1010 de 2006.",

            'alcance' => "Define el alcance de la Politica de Prevencion del Acoso Laboral.
Debe especificar que aplica a:
- Todos los trabajadores sin importar nivel jerarquico
- Relaciones entre jefes y subordinados (vertical)
- Relaciones entre companeros (horizontal)
- Contratistas y personal tercerizado
- Todas las sedes e instalaciones
Para empresas de {$estandares} estandares, ajusta el alcance proporcionalmente.",

            'declaracion' => "Genera la declaracion formal de la Politica de Prevencion del Acoso Laboral.
Debe incluir el compromiso explicito de la alta direccion con:
- Tolerancia cero frente al acoso laboral
- Respeto a la dignidad humana
- Ambiente laboral libre de hostigamiento
- Canales seguros de denuncia sin represalias
- Sanciones proporcionales a quienes incurran en acoso
FORMATO: Redactar en primera persona plural.
TONO: Formal, comprometido, contundente contra el acoso.",

            'definiciones' => "Define el acoso laboral y sus modalidades segun la Ley 1010 de 2006.
DEFINICION GENERAL (Art. 2):
Toda conducta persistente y demostrable ejercida sobre un trabajador que busque infundir miedo, intimidacion, terror, angustia, causar perjuicio laboral, generar desmotivacion o inducir la renuncia.

MODALIDADES (Art. 2):
1. Maltrato laboral: violencia fisica o verbal, injuria, calumnia
2. Persecucion laboral: conductas reiteradas arbitrarias para inducir renuncia
3. Discriminacion laboral: trato diferenciado por motivos prohibidos
4. Entorpecimiento laboral: obstaculizar el cumplimiento del trabajo
5. Inequidad laboral: asignacion de funciones menospreciando al trabajador
6. Desproteccion laboral: no proveer condiciones de proteccion

FORMATO: Lista estructurada con definiciones claras.",

            'conductas' => "Lista las conductas que constituyen acoso laboral segun Ley 1010 de 2006 Art. 7.
CONDUCTAS CONSTITUTIVAS:
1. Agresion fisica sin importar consecuencias
2. Expresiones injuriosas o ultrajantes sobre la persona
3. Comentarios hostiles y humillantes de descalificacion profesional
4. Injustificadas amenazas de despido
5. Descalificacion humillante de propuestas o trabajo
6. Burlas sobre apariencia fisica o forma de vestir
7. Alusion publica a hechos de la vida privada
8. Imposicion de deberes ajenos a las funciones
9. Exigencia de horarios excesivos respecto a la jornada
10. Trato discriminatorio
11. Negativa injustificada a conceder permisos o licencias
12. Envio de comunicaciones anonimas, llamadas o mensajes injuriosos

FORMATO: Lista numerada con descripcion breve de cada conducta.",

            'conductas_no_acoso' => "Lista las conductas que NO constituyen acoso laboral segun Ley 1010 de 2006 Art. 8.
NO CONSTITUYEN ACOSO LABORAL:
1. Las exigencias y ordenes necesarias para mantener la disciplina
2. Los actos destinados a ejercer potestad disciplinaria legal
3. La formulacion de memorandos solicitando mayor eficiencia
4. La solicitud de cumplir deberes de la relacion laboral
5. La exigencia de cumplir obligaciones del contrato
6. La terminacion del contrato con justa causa debidamente sustentada
7. La evaluacion objetiva del desempeno
8. Las circulares o memorandos de trabajo dirigidos a mejorar el servicio

IMPORTANTE: Estas conductas deben ejercerse de forma respetuosa, no arbitraria y con respeto a la dignidad humana.",

            'mecanismos_prevencion' => "Describe los mecanismos de prevencion del acoso laboral segun Ley 1010 Art. 9.
MECANISMOS:
1. Informar sobre contenido de la Ley 1010 y procedimientos
2. Espacios de dialogo para construir relaciones laborales positivas
3. Actividades de capacitacion en convivencia y comunicacion
4. Conformacion del Comite de Convivencia Laboral (Res. 652/2012)
5. Evaluacion periodica del clima laboral
6. Codigo de etica o manual de convivencia
7. Procedimiento interno confidencial de queja

Para {$estandares} estandares, mencionar Vigia/COPASST segun corresponda.
IMPORTANTE: Comite de Convivencia es obligatorio para todas las empresas.",

            'procedimiento_denuncia' => "Describe el procedimiento para denunciar acoso laboral.
PASOS:
1. Denuncia: El trabajador puede presentar queja ante:
   - Comite de Convivencia Laboral
   - Inspector del Trabajo
   - Juez laboral (accion de tutela si hay derechos vulnerados)

2. Comite de Convivencia Laboral:
   - Recibe la queja
   - Escucha a las partes
   - Propone compromisos de mejora
   - Hace seguimiento a los acuerdos
   - Si no hay solucion, remite a instancias superiores
...
4. Terminos:
   - Las acciones caducan 6 meses despues del ultimo hecho (Art. 18)

FORMATO: Procedimiento paso a paso.",

            'marco_legal' => "Lista el marco normativo aplicable a la Politica de Acoso Laboral.
NORMATIVA ESENCIAL:
- Constitucion Politica: Art. 1, 13, 25 (dignidad, igualdad, trabajo)
- Ley 1010 de 2006: Medidas para prevenir y sancionar el acoso laboral
- Resolucion 652 de 2012: Comite de Convivencia Laboral
- Resolucion 1356 de 2012: Modifica conformacion del Comite
- Decreto 1072 de 2015: Sector Trabajo
- Resolucion 0312 de 2019: Estandares Minimos del SG-SST
- Codigo Sustantivo del Trabajo: Obligaciones del empleador

FORMATO: Lista con vinetas, NO usar tablas.",

            'comunicacion' => "Define como se comunicara y divulgara la politica de acoso laboral.
INCLUIR:
...
- Inclusion en Reglamento Interno de Trabajo
- Capacitaciones sobre convivencia laboral
- Difusion de canales de denuncia

IMPORTANTE: Para {$estandares} estandares, usar 'Vigia SST' si son 7 estandares, 'COPASST' si son 21 o mas."
        ];

        return $prompts[$seccionKey] ?? "Genera el contenido para la seccion '{$seccionKey}' de la Politica de Prevencion del Acoso Laboral.";
    }
