...
class PoliticaSstGeneral extends AbstractDocumentoSST
{
    ...
    {
        $prompts = [
            'objetivo' => "Genera el objetivo de la Política de Seguridad y Salud en el Trabajo.
Debe expresar el compromiso de la alta dirección con:
...
IMPORTANTE: Máximo 2-3 párrafos concisos.",
            ...
            'alcance' => "Define el alcance de la Política de SST.
Debe especificar que aplica a:
- Todos los trabajadores (directos y temporales)
- Contratistas y subcontratistas
- Visitantes
- Todas las actividades y procesos de la empresa
IMPORTANTE: Para empresas de {$estandares} estándares, mantén un alcance proporcional.",

            'declaracion' => "Genera la declaración formal de la Política de SST.
Debe incluir el compromiso explícito de la alta dirección con:
- Identificación de peligros, evaluación y valoración de riesgos
- Protección de la seguridad y salud de trabajadores
- Cumplimiento de normatividad legal vigente
- Garantía de participación de trabajadores y sus representantes
- Mejora continua del SG-SST
FORMATO: Redactar en primera persona plural (nosotros, la empresa).
TONO: Formal, comprometido, claro.",

            'compromisos_empleador' => "Genera los compromisos específicos del empleador según Decreto 1072/2015 Art. 2.2.4.6.5.
COMPROMISOS OBLIGATORIOS:
1. Definir, firmar, divulgar y actualizar la política
2. Rendir cuentas sobre el desempeño del SG-SST
3. Cumplir los requisitos normativos aplicables
4. Gestionar los peligros y riesgos
5. Desarrollar plan de trabajo anual
6. Prevenir lesiones y enfermedades laborales
7. Proteger la seguridad de todos los trabajadores
8. Participación de trabajadores en el SG-SST
9. Garantizar capacitación en SST
10. Asignar recursos para el SG-SST
IMPORTANTE: Para {$estandares} estándares, prioriza los más relevantes.",

            'compromisos_trabajadores' => "Genera los compromisos de los trabajadores según Ley 1562/2012 Art. 10.
INCLUIR:
- Procurar el cuidado integral de su salud
- Suministrar información clara y veraz sobre su estado de salud
- Cumplir normas, reglamentos e instrucciones del SG-SST
- Informar oportunamente sobre peligros y riesgos
- Participar en actividades de capacitación
- Participar y contribuir al cumplimiento de objetivos del SG-SST
FORMATO: Lista de viñetas, máximo 6-8 compromisos.",

            'marco_legal' => "Lista el marco normativo aplicable a la Política de SST.
NORMATIVA ESENCIAL:
- Constitución Política de Colombia (Art. 25, 48, 49)
...
FORMATO: Lista con viñetas, NO usar tablas.",
            ...
            'comunicacion' => "Define cómo se comunicará y divulgará la política.
INCLUIR:
- Comunicación al COPASST/Vigía SST (según estándares)
- Publicación en lugares visibles
- Inclusión en inducción y reinducción
- Entrega a contratistas
- Actualización anual o cuando sea necesario
IMPORTANTE: Para {$estandares} estándares, usar 'Vigía SST' si son 7 estándares, 'COPASST' si son 21 o más."
        ];

        return $prompts[$seccionKey] ?? "Genera el contenido para la sección '{$seccionKey}' de la Política de SST.";
    }
