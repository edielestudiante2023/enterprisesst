...
class PoliticaDiscriminacion extends AbstractDocumentoSST
{
    ...
    {
        $prompts = [
            'objetivo' => "Genera el objetivo de la Politica de Prevencion de la Discriminacion, Maltrato y Violencia.
Debe expresar el compromiso de la organizacion con:
- Igualdad de trato y oportunidades para todos
- Ambiente laboral libre de discriminacion
- Prevencion del maltrato y la violencia laboral
- Dignidad humana como principio fundamental
IMPORTANTE: Maximo 2-3 parrafos, mencionar Constitucion Art. 13 y Ley 1010.",

            'alcance' => "Define el alcance de la Politica de Prevencion de la Discriminacion, Maltrato y Violencia.
Debe especificar que aplica a:
- Todos los trabajadores sin excepcion
- Procesos de seleccion, contratacion, promocion
- Relaciones laborales cotidianas
- Contratistas y terceros
- Todas las formas de comunicacion
Para empresas de {$estandares} estandares, ajusta el alcance proporcionalmente.",

            'declaracion' => "Genera la declaracion formal de la Politica de Prevencion de la Discriminacion.
Debe incluir el compromiso explicito de la alta direccion con:
- Tolerancia cero frente a la discriminacion en cualquier forma
- Igualdad de oportunidades sin distincion alguna
- Respeto a la diversidad y la diferencia
- Ambiente laboral libre de maltrato y violencia
- Mecanismos de denuncia seguros y efectivos
FORMATO: Redactar en primera persona plural.
TONO: Formal, inclusivo, comprometido con la diversidad.",

            'definiciones' => "Define los conceptos clave relacionados con discriminacion, maltrato y violencia.
INCLUIR:
1. Discriminacion: trato diferenciado injustificado
2. Discriminacion directa: trato menos favorable explicito
3. Discriminacion indirecta: normas aparentemente neutras con efecto discriminatorio
4. Criterios sospechosos de discriminacion (Art. 13 CP): raza, sexo, origen, religion, opinion politica, etc.
5. Maltrato laboral: violencia fisica o verbal en el trabajo
6. Violencia laboral: agresiones fisicas, verbales o psicologicas
7. Inclusion: integracion plena respetando diferencias
8. Diversidad: reconocimiento de las diferencias humanas

FORMATO: Definiciones claras y comprensibles.",

            'principios' => "Describe los principios rectores de la politica.
INCLUIR:
1. Dignidad humana: respeto a todas las personas
2. Igualdad: mismo trato sin distincion
3. No discriminacion: prohibicion de trato diferenciado injustificado
4. Diversidad e inclusion: valoracion de las diferencias
5. Respeto: trato cordial y profesional
6. Equidad: reconocer diferencias para garantizar igualdad real
7. Confidencialidad: proteccion de informacion de denuncias
8. Debido proceso: garantias para acusados

FORMATO: Lista con descripcion breve de cada principio.",

            'conductas_prohibidas' => "Lista las conductas prohibidas relacionadas con discriminacion, maltrato y violencia.
DISCRIMINACION POR:
- Raza, color de piel o etnia
- Sexo, genero, orientacion sexual, identidad de genero
- Religion o creencias
- Opinion politica o sindical
...
- Apariencia fisica
- Enfermedad (incluyendo VIH/SIDA)

MALTRATO Y VIOLENCIA:
- Agresion fisica
- Insultos, gritos, palabras ofensivas
- Humillaciones publicas o privadas
- Amenazas o intimidacion
- Exclusion deliberada
- Sobrecarga de trabajo como castigo

FORMATO: Lista categorizada con ejemplos.",

            'mecanismos_prevencion' => "Describe los mecanismos de prevencion de discriminacion, maltrato y violencia.
INCLUIR:
1. Proceso de seleccion basado en competencias, no en criterios discriminatorios
2. Capacitacion en diversidad e inclusion
3. Sensibilizacion sobre sesgos inconscientes
4. Comite de Convivencia Laboral como instancia de prevencion
5. Evaluacion de clima laboral con enfoque de inclusion
6. Canales de denuncia confidenciales
7. Ajustes razonables para personas con discapacidad
8. Lenguaje inclusivo en comunicaciones

Para {$estandares} estandares, ajustar complejidad del programa.",

            'procedimiento' => "Describe el procedimiento para denunciar discriminacion, maltrato o violencia.
PASOS:
...
2. Recepcion y evaluacion:
   - Registro confidencial de la denuncia
   - Evaluacion preliminar de los hechos
...
4. Resolucion:
   ...
   - Aplicacion de sanciones si corresponde
...
GARANTIAS: Confidencialidad, no represalias, debido proceso.",

            'marco_legal' => "Lista el marco normativo aplicable.
NORMATIVA ESENCIAL:
- Constitucion Politica: Art. 13 (igualdad y no discriminacion)
- Ley 1010 de 2006: Acoso laboral
- Ley 1482 de 2011: Discriminacion como delito
- Ley 1752 de 2015: Modifica Ley 1482 sobre discriminacion
- Ley 361 de 1997: Integracion social de personas con discapacidad
- Ley 1618 de 2013: Derechos de personas con discapacidad
- Convenio 111 OIT: Discriminacion en empleo y ocupacion
...
- Publicacion visible en las instalaciones
- Inclusion en induccion y reinduccion
- Capacitaciones periodicas sobre diversidad e inclusion
...
IMPORTANTE: Para {$estandares} estandares, usar 'Vigia SST' si son 7, 'COPASST' si son 21 o mas."
        ...
        return $prompts[$seccionKey] ?? "Genera el contenido para la seccion '{$seccionKey}' de la Politica de Prevencion de la Discriminacion, Maltrato y Violencia.";
    }
