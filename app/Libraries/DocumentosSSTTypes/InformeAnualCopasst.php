...
/**
 * Clase InformeAnualCopasst
 *
 * Informe anual de gestion del COPASST (numeral 1.1.6 — vive en la carpeta de Conformacion COPASST).
 *
 * Flujo: secciones_ia. Sobrescribe getContextoBase() para inyectar a la IA todo el anio
 * (4 trimestres) consultado de las tablas del modulo /actas/20, mas un comparativo trimestral.
 *
 * Ver docs/MODULO_NUMERALES_SGSST/10_DOCUMENTOS_ESPECIFICOS/InformeAnualCopasst.md
 *
 * @package App\Libraries\DocumentosSSTTypes
 */
class InformeAnualCopasst extends AbstractDocumentoSST
{
    public function getTipoDocumento(): string
    {
        return 'informe_anual_copasst';
    }

    public function getNombre(): string
    {
        return 'Informe Anual de Gestion del COPASST';
    }

    public function getDescripcion(): string
    {
        return 'Informe anual de gestion del COPASST con datos reales del comite y comparativo trimestral.';
    }
    ...
    public function getSecciones(): array
    {
        return [
            ...
            ['numero' => 6,  'nombre' => 'Decisiones y Votaciones del Anio',       'key' => 'decisiones_votaciones'],
    ...
    /**
     * Sobrescribe getContextoBase para inyectar TODO el anio + comparativo trimestral.
     */
    public function getContextoBase(array $cliente, ?array $contexto): string
    {
        ...
        return $base
            . "\n\n============================================================\n"
            . "DATOS REALES DEL COPASST EN EL ANIO {$anio}\n"
            . "============================================================\n"
            . $bloqueAnual
            . "\n\n============================================================\n"
    ...
    /**
     * Bloque de datos del comite + actas + asistencia + compromisos para todo el anio.
     */
    protected function bloqueAnual(int $idCliente, int $anio): string
    {
        ...
        if (!$comite) {
            return "[ATENCION] No hay COPASST activo registrado para este cliente. La IA debera generar el informe asumiendo que aun no hay datos operativos del comite.\n";
        }
    ...
    /**
     * Comparativo agregado por trimestre dentro del anio.
     */
