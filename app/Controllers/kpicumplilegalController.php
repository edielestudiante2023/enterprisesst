...
class kpicumplilegalController extends Controller
{



    public function cumplilegalKpi($urlClientId = null)
    {
        ...
        $id_kpis = 7; // Primer indicador: Plan de Trabajo Anual
        ...
        return view('client/sgsst/kpi/kcumplilegal', $data);
    }
}
