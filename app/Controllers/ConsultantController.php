...
class ConsultantController extends Controller
{
    ...
    public function addClientPost()
    {
        ...
        if (!TenantFilter::consultorEnMiEmpresa((int)$id_consultor)) {
            log_message('warning', 'addClientPost BLOCKED consultor ajeno id_consultor=' . $id_consultor);
    ...
    public function updateClient($id)
    {
        ...
        // Seguridad multi-tenant: validar que el consultor nuevo pertenezca a la empresa del usuario
        ...
        if ($nuevoIdConsultor && !TenantFilter::consultorEnMiEmpresa((int)$nuevoIdConsultor)) {
            log_message('warning', 'updateClient BLOCKED consultor ajeno id_cliente=' . $id . ' id_consultor=' . $nuevoIdConsultor);
            return redirect()->back()->with('error', 'Consultor invalido.');
        }
