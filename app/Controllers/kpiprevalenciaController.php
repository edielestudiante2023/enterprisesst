...
class kpiprevalenciaController extends Controller
{



    public function prevalenciaKpi($urlClientId = null)
    {
        ...
        $id_kpis = 14; // Primer indicador: Plan de Trabajo Anual
        ...
        return view('client/sgsst/kpi/kprevalencia', $data);
    }
}
