...
class PzinscripcioncopasstController extends Controller
{



    public function inscripcionCopasst($urlClientId = null)
    {
        ...
        $policyTypeId = 9; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p1_1_7inscripcioncopasst', $data);
    }

    public function generatePdf_inscripcionCopasst()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p1_1_7inscripcioncopasst', $data);
        ...
        $dompdf->stream('inscripcion_copasst.pdf', ['Attachment' => false]);
    }
}
