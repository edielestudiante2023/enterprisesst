...
class PzreghigsegindController extends Controller
{



    public function regHigsegind($urlClientId = null)
    {
        ...
        $policyTypeId = 26; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p2_1_6reghigsegind', $data);
    }

    public function generatePdf_regHigsegind()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p2_1_6reghigsegind', $data);
        ...
        $dompdf->stream('reglamento_hig_seg_ind.pdf', ['Attachment' => false]);
    }
}
