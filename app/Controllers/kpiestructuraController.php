...
class kpiestructuraController extends Controller
{



    public function estructuraKpi($urlClientId = null)
    {
        ...
        $id_kpis = 9; // Primer indicador: Plan de Trabajo Anual
        ...
        return view('client/sgsst/kpi/kinfraestructura', $data);
    }
}
