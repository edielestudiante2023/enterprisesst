...
class HzaccioncorrectivaController extends Controller
{
    ...
    public function generatePdf_accionCorrectiva()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/h2_1_2accioncorrectiva', $data);
        ...
        $dompdf->stream('accioncorrectiva.pdf', ['Attachment' => false]);
    }
}
