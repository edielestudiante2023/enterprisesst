...
class kpiseisperiodosController extends Controller
{



    public function indicadorseisPeriodos($urlClientId = null)
    {
        ...
        return view('client/sgsst/kpi/seisperiodos', $data);
    }
}
