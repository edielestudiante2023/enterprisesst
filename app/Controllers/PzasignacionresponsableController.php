...
class PzasignacionresponsableController extends Controller
{
    ...
    public function asignacionResponsable($urlClientId = null)
    {
        ...
        return view('client/sgsst/1planear/p1_1_1asignacion_responsable', $data);
    }

    public function generatePdf_asignacionResponsable()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p1_1_1asignacion_responsable', $data);
        ...
        $dompdf->stream('asignacion_responsable.pdf', ['Attachment' => false]);
    }
}
