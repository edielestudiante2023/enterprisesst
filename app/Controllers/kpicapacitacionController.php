...
class kpicapacitacionController extends Controller
{



    public function capacitacionKpi($urlClientId = null)
    {
        ...
        $id_kpis = 8; // Primer indicador: Plan de Trabajo Anual
        ...
        return view('client/sgsst/kpi/ktcapacitacion', $data);
    }
}
