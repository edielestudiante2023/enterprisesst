...
class kpigestionriesgoController extends Controller
{



    public function gestionriesgoKpi($urlClientId = null)
    {
        ...
        $id_kpis = 3; // Primer indicador: Plan de Trabajo Anual
        ...
        return view('client/sgsst/kpi/k3gestionriesgo', $data);
    }
}
