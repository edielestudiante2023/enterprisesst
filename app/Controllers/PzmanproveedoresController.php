...
class PzmanproveedoresController extends Controller
{



    public function manProveedores($urlClientId = null)
    {
        ...
        return view('client/sgsst/1planear/p2_5_4manproveedores', $data);
    }

    public function generatePdf_manProveedores()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p2_5_4manproveedores', $data);
        ...
        $dompdf->stream('manProveedores.pdf', ['Attachment' => false]);
    }
}
