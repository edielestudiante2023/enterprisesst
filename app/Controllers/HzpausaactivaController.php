...
class HzpausaactivaController extends Controller
{



    public function pausasActivas($urlClientId = null)
    {
        ...
        $policyTypeId = 42; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/h2_1_3pausasactivas', $data);
    }
    ...
    public function generatePdf_pausasActivas()
    {
        ...
        $html = view('client/sgsst/1planear/h2_1_3pausasactivas', $data);
        ...
        $dompdf->stream('pausasactivas.pdf', ['Attachment' => false]);
    }
}
