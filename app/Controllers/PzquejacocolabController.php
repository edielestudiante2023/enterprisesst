...
class PzquejacocolabController extends Controller
{
    ...
    public function quejaCocolab($urlClientId = null)
    {
        ...
        $policyTypeId = 13; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p1_1_11quejacocolab', $data);
    }

    public function generatePdf_quejaCocolab()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p1_1_11quejacocolab', $data);
        ...
        $dompdf->stream('queja_cocolab.pdf', ['Attachment' => false]);
    }
}
