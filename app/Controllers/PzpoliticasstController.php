...
class PzpoliticasstController extends Controller
{



    public function politicaSst($urlClientId = null)
    {
        ...
        $policyTypeId = 21; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p2_1_1politicasst', $data);
    }

    public function generatePdf_politicaSst()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p2_1_1politicasst', $data);
        ...
        $dompdf->stream('politica_sst.pdf', ['Attachment' => false]);
    }
}
