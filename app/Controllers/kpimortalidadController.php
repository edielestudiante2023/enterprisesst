...
class kpimortalidadController extends Controller
{



    public function mortalidadKpi($urlClientId = null)
    {
        ...
        $id_kpis = 13; // Primer indicador: Plan de Trabajo Anual
        ...
        return view('client/sgsst/kpi/kmortalidad', $data);
    }
}
