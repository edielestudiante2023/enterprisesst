...
class HzrevaltagerenciaController extends Controller
{



    public function revisionAltagerencia($urlClientId = null)
    {
        ...
        $policyTypeId = 40; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/h1_1_8revaltadireccion', $data);
    }

    public function generatePdf_revisionAltagerencia()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/h1_1_8revaltadireccion', $data);
        ...
        $dompdf->stream('revaltadireccion.pdf', ['Attachment' => false]);
    }
}
