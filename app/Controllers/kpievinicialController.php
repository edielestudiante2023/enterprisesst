...
class kpievinicialController extends Controller
{



    public function evinicialKpi($urlClientId = null)
    {
        ...
        $id_kpis = 5; // Primer indicador: Plan de Trabajo Anual
        ...
        return view('client/sgsst/kpi/kevinicial', $data);
    }
}
