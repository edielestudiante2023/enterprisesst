...
class PzinpeccionplanynoplanController extends Controller
{



    public function inspeccionPlanynoplan($urlClientId = null)
    {
        ...
        $policyTypeId = 35; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/h1_1_4inspeccionesplanynoplan', $data);
    }

    public function generatePdf_inspeccionPlanynoplan()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/h1_1_4inspeccionesplanynoplan', $data);
        ...
        $dompdf->stream('inspeccionesplanynoplan.pdf', ['Attachment' => false]);
    }
}
