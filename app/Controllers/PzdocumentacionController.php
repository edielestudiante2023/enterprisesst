...
class PzdocumentacionController extends Controller
{



    public function documentosSgsst($urlClientId = null)
    {
        ...
        $policyTypeId = 28; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p2_5_1documentacion', $data);
    }

    public function generatePdf_documentosSgsst()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p2_5_1documentacion', $data);
        ...
        $dompdf->stream('documentacionsst.pdf', ['Attachment' => false]);
    }
}
