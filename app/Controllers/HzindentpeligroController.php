...
class HzindentpeligroController extends Controller
{



    public function indentPeligros($urlClientId = null)
    {
        ...
        $policyTypeId = 39; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/h1_1_7identfpeligriesg', $data);
    }

    public function generatePdf_indentPeligros()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/h1_1_7identfpeligriesg', $data);
        ...
        $dompdf->stream('indentpeligros.pdf', ['Attachment' => false]);
    }
}
