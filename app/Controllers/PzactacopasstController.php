...
class PzactacopasstController extends Controller
{



    public function actaCopasst($urlClientId = null)
    {
        ...
        $policyTypeId = 8; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p1_1_6actareunioncopasst', $data);
    }

    public function generatePdf_actaCopasst()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p1_1_6actareunioncopasst', $data);
        ...
        $dompdf->stream('acta_copasst.pdf', ['Attachment' => false]);
    }
}
