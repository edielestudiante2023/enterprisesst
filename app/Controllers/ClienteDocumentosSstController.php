...
class ClienteDocumentosSstController extends Controller
{
    ...
    protected function determinarTipoCarpetaFases(array $carpeta): ?string
    {
        ...
        $mapaCodigos = [
            ...
            '1.2.4' => 'reglamento_higiene_seguridad',
            '2.1.1' => 'politicas_2_1_1',
            '2.2.1' => 'plan_objetivos_metas',
            ...
            '2.9.1' => 'adquisiciones_sst',
            '2.10.1' => 'evaluacion_proveedores',
            '2.11.1' => 'evaluacion_impacto_cambios',
            ...
            '3.1.7' => 'estilos_vida_saludable',
            '3.1.8' => 'agua_servicios_sanitarios',
            '3.1.9' => 'eliminacion_residuos',
            '3.2.1' => 'reporte_accidentes_trabajo',
            '3.2.2' => 'investigacion_incidentes',
            '4.1.1' => 'metodologia_identificacion_peligros',
            '4.1.3' => 'identificacion_sustancias_cancerigenas',
            '4.1.4' => 'mediciones_ambientales',
            '4.2.1' => 'medidas_prevencion_control',
            '4.2.2' => 'verificacion_medidas_prevencion',
            '4.2.3' => 'procedimientos_seguridad',
            '4.2.4' => 'programa_inspecciones',
            '4.2.5' => 'mantenimiento_periodico',
            '4.2.6' => 'entrega_epp',
            '5.1.1' => 'plan_emergencias',
            '5.1.2' => 'brigada_emergencias',
            '6.1.1' => 'indicadores_sgsst',
            '6.1.2' => 'auditoria_anual',
            '6.1.3' => 'revision_direccion',
            '6.1.4' => 'planificacion_auditorias_copasst',
            '7.1.1' => 'acciones_resultados_sgsst',
            '7.1.2' => 'acciones_efectividad_medidas',
            '7.1.3' => 'acciones_investigacion_atel',
            '7.1.4' => 'acciones_arl_autoridades',
        ];
    ...
    protected function getFiltrosTipoCarpeta(): array
    {
        return [
            ...
            'reglamento_higiene_seguridad' => ['reglamento_higiene_seguridad'],
            ...
            'adquisiciones_sst' => ['procedimiento_adquisiciones'],
            'evaluacion_proveedores' => ['procedimiento_evaluacion_proveedores'],
            'evaluacion_impacto_cambios' => ['procedimiento_gestion_cambio'],
            ...
            'reporte_accidentes_trabajo' => ['procedimiento_investigacion_accidentes'],
            'investigacion_incidentes' => ['procedimiento_investigacion_incidentes'],
            'metodologia_identificacion_peligros' => ['metodologia_identificacion_peligros'],
            'identificacion_sustancias_cancerigenas' => ['identificacion_sustancias_cancerigenas'],
            ...
            'procedimientos_seguridad' => ['pve_riesgo_biomecanico', 'pve_riesgo_psicosocial'],
            ...
            'auditoria_anual' => ['procedimiento_auditoria_anual'],
            'revision_direccion' => ['soporte_revision_direccion'],
            'planificacion_auditorias_copasst' => ['soporte_planificacion_auditoria'],
            'acciones_resultados_sgsst' => ['acciones_resultados_sgsst'],
            'acciones_efectividad_medidas' => ['acciones_efectividad_medidas'],
            'acciones_investigacion_atel' => ['acciones_investigacion_atel'],
            'acciones_arl_autoridades' => ['acciones_arl_autoridades'],
        ];
    }
