...
class PzconfidencialidadcocolabController extends Controller
{



    public function confidencialidadCocolab($urlClientId = null)
    {
        ...
        $policyTypeId = 11; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p1_1_9confidencialidadcocolab', $data);
    }

    public function generatePdf_confidencialidadCocolab()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p1_1_9confidencialidadcocolab', $data);
        ...
        $dompdf->stream('formato_asistencia.pdf', ['Attachment' => false]);
    }
}
