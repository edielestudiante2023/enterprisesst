...
class PzpoliticaalcoholController extends Controller
{



    public function politicaAlcohol($urlClientId = null)
    {
        ...
        $policyTypeId = 22; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p2_1_2politicaalcohol', $data);
    }

    public function generatePdf_politicaAlcohol()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p2_1_2politicaalcohol', $data);
        ...
        $dompdf->stream('politica_alcohol.pdf', ['Attachment' => false]);
    }
}
