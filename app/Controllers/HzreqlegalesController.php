...
class HzreqlegalesController extends Controller
{



    public function requisitosLegales($urlClientId = null)
    {
        ...
        $policyTypeId = 43; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/h2_1_4reqlegales', $data);
    }

    public function generatePdf_requisitosLegales()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/h2_1_4reqlegales', $data);
        ...
        $dompdf->stream('reqlegales.pdf', ['Attachment' => false]);
    }
}
