...
class PzcomunicacionController extends Controller
{



    public function comunicacionInterna($urlClientId = null)
    {
        ...
        $policyTypeId = 30; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p2_5_3comunicacion', $data);
    }

    public function generatePdf_comunicacionInterna()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p2_5_3comunicacion', $data);
        ...
        $dompdf->stream('comunicacionInterna.pdf', ['Attachment' => false]);
    }
}
