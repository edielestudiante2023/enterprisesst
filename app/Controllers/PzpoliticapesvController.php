...
class PzpoliticapesvController extends Controller
{



    public function politicaPesv($urlClientId = null)
    {
        ...
        $policyTypeId = 25; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p2_1_5politicapesv', $data);
    }

    public function generatePdf_politicaPesv()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p2_1_5politicapesv', $data);
        ...
        $dompdf->stream('politica_pesv.pdf', ['Attachment' => false]);
    }
}
