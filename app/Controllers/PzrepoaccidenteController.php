...
class PzrepoaccidenteController extends Controller
{



    public function reporteAccidente($urlClientId = null)
    {
        ...
        $policyTypeId = 34; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/h1_1_3repoaccidente', $data);
    }

    public function generatePdf_reporteAccidente()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/h1_1_3repoaccidente', $data);
        ...
        $dompdf->stream('repoaccidente.pdf', ['Attachment' => false]);
    }
}
