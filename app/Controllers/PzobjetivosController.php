...
class PzobjetivosController extends Controller
{



    public function oBjetivos($urlClientId = null)
    {
        ...
        $policyTypeId = 27; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p2_2_1objetivos', $data);
    }

    public function generatePdf_oBjetivos()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p2_2_1objetivos', $data);
        ...
        $dompdf->stream('objetivos.pdf', ['Attachment' => false]);
    }
}
