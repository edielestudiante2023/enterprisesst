...
class HzrespsaludController extends Controller
{



    public function responsabilidadesSalud($urlClientId = null)
    {
        ...
        $policyTypeId = 38; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/h1_1_6respsalud', $data);
    }

    public function generatePdf_responsabilidadesSalud()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/h1_1_6respsalud', $data);
        ...
        $dompdf->stream('recomendacionessalud.pdf', ['Attachment' => false]);
    }
}
