...
class kpiincidenciaController extends Controller
{



    public function incidenciaKpi($urlClientId = null)
    {
        ...
        $id_kpis = 15; // Primer indicador: Plan de Trabajo Anual
        ...
        return view('client/sgsst/kpi/kincidencia', $data);
    }
}
