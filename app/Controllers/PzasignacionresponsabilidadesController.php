...
class PzasignacionresponsabilidadesController extends Controller
{



    public function asignacionResponsabilidades($urlClientId = null)
    {
        ...
        return view('client/sgsst/1planear/p1_1_2asignacion_responsabilidades', $data);
    }
    ...
    public function generatePdf_asignacionResponsabilidades()
    {
        ...
        $html = view('client/sgsst/1planear/p1_1_2asignacion_responsabilidades', $data);
        ...
        $dompdf->stream('asignacion_responsabilidades.pdf', ['Attachment' => false]);
    }
}
