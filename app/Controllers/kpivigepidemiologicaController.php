...
class kpivigepidemiologicaController extends Controller
{



    public function vigepidemiologicaKpi($urlClientId = null)
    {
        ...
        $id_kpis = 4; // Primer indicador: Plan de Trabajo Anual
        ...
        return view('client/sgsst/kpi/k4vigilanciaepidemiologica', $data);
    }
}
