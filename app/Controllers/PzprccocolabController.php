...
class PzprccocolabController extends Controller
{



    public function prcCocolab($urlClientId = null)
    {
        ...
        $policyTypeId = 17; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p1_1_13prcconvivencialaboral', $data);
    }

    public function generatePdf_prcCocolab()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p1_1_13prcconvivencialaboral', $data);
        ...
        $dompdf->stream('prc_cocolab.pdf', ['Attachment' => false]);
    }
}
