...
class kpitresperiodosController extends Controller
{



    public function indicadorTresPeriodos($urlClientId = null)
    {
        ...
        return view('client/sgsst/kpi/tresperiodos', $data);
    }
}
