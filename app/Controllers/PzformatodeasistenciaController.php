...
class PzformatodeasistenciaController extends Controller
{



    public function formatoAsistencia($urlClientId = null)
    {
        ...
        $policyTypeId = 10; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p1_1_8formatoasistencia', $data);
    }

    public function generatePdf_formatoAsistencia()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p1_1_8formatoasistencia', $data);
