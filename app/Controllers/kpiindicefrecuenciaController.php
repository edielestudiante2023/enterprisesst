...
class kpiindicefrecuenciaController extends Controller
{



    public function indicefrecuenciaKpi($urlClientId = null)
    {
        ...
        $id_kpis = 11; // Primer indicador: Plan de Trabajo Anual
        ...
        return view('client/sgsst/kpi/k6indicefrecuencia', $data);
    }
}
