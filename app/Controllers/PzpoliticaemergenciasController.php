...
class PzpoliticaemergenciasController extends Controller
{



    public function politicaEmergencias($urlClientId = null)
    {
        ...
        $policyTypeId = 23; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p2_1_3politicaemergencias', $data);
    }

    public function generatePdf_politicaEmergencias()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p2_1_3politicaemergencias', $data);
        ...
        $dompdf->stream('politica_emergencias.pdf', ['Attachment' => false]);
    }
}
