...
class PzregistroasistenciaController extends Controller
{



    public function registroAsistencia($urlClientId = null)
    {
        ...
        $policyTypeId = 7; // Supongamos que el ID de la política de alcohol y drogas es 1
        ...
        return view('client/sgsst/1planear/p1_1_5registro_asistencia', $data);
    }

    public function generatePdf_registroAsistencia()
    {
        // Instanciar Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('client/sgsst/1planear/p1_1_5registro_asistencia', $data);
        ...
        $dompdf->stream('registro_asistencia.pdf', ['Attachment' => false]);
    }
}
