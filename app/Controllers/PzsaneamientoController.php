...
class PzsaneamientoController extends Controller
{
    ...
    public function saneamientoBasico($urlClientId = null)
    {
        ...
        $policyTypeId = 32; // Supongamos que el ID de la política de alcohol y drogas es 1
    ...
    public function generatePdf_saneamientoBasico()
    {
        ...
        $dompdf->stream('examed.pdf', ['Attachment' => false]);
    }
}
